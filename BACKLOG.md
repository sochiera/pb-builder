...
## US-002 — Składający sprawdza dopasowanie chłodzenia do procesora  [do weryfikacji]
...
## US-003 — Składający sprawdza możliwość podłączenia dysku  [do weryfikacji]
...
## US-004 — Składający wraca do zachowanego zestawu  [do weryfikacji]
